        ...
        return (
            <div className="container-fluid">
                <div className="container main">
                    <p className="welcome">Szyfr MD5</p>
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="modeText"> Tryb: {this.state.decode ? 'Rozszyfrowywanie' : 'Szyfrowanie'}{' '}</div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-sm-12">
                    ...
                    <div className="row">
                        <div className="col-sm-12 calculate">
                            <button className='modeButton' onClick={()=>this.hash(this.state.text)}>Przelicz</button>
                        </div>
                    </div>
                    <div className="row">
